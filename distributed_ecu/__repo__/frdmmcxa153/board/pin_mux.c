...
- {pin_num: '62', pin_signal: P1_4/WUU0_IN8/FREQME_CLK_IN0/LPSPI0_PCS3/LPUART2_RXD/CT1_MAT2/ADC0_A20/CMP0_IN2, label: BOARD_ILI9341_DC_PIN, identifier: BOARD_ILI9341_DC_PIN}
- {pin_num: '63', pin_signal: P1_5/FREQME_CLK_IN1/LPSPI0_PCS2/LPUART2_TXD/CT1_MAT3/ADC0_A21/CMP1_IN2, label: BOARD_ILI9341_RST_PIN, identifier: BOARD_ILI9341_RST_PIN}
- {pin_num: '64', pin_signal: P1_6/TRIG_IN2/LPSPI0_PCS1/LPUART2_RTS_B/CT_INP6/ADC0_A22, label: BOARD_ILI9341_BL_PIN, identifier: BOARD_ILI9341_BL_PIN}
...
- pin_list:
  ...
  - {pin_num: '57', peripheral: LPSPI0, signal: SCK, pin_signal: P1_1/TRIG_IN1/LPSPI0_SCK/LPI2C0_SCL/CT_INP5/CT0_MAT3/ADC0_A17/CMP1_IN3}
  - {pin_num: '58', peripheral: LPSPI0, signal: IN, pin_signal: P1_2/TRIG_OUT0/LPSPI0_SDI/LPI2C0_SDAS/CT1_MAT0/CT_INP0/ADC0_A18}
  - {pin_num: '56', peripheral: LPSPI0, signal: OUT, pin_signal: P1_0/WUU0_IN6/LPTMR0_ALT3/TRIG_IN0/LPSPI0_SDO/LPI2C0_SDA/CT_INP4/CT0_MAT2/ADC0_A16/CMP0_IN3}
  - {pin_num: '59', peripheral: LPSPI0, signal: PCS0, pin_signal: P1_3/WUU0_IN7/TRIG_OUT1/LPSPI0_PCS0/LPI2C0_SCLS/CT1_MAT1/CT_INP1/ADC0_A19/CMP0_IN1}
...
void BOARD_InitPins(void)
{
    ...
    PORT1->PCR[0] = ((PORT1->PCR[0] &
                     ...
                     /* Pin Multiplex Control: PORT1_0 (pin 56) is configured as LPSPI0_SDO. */
                     | PORT_PCR_MUX(PORT1_PCR0_MUX_mux10)
    ...
    PORT1->PCR[1] = ((PORT1->PCR[1] &
                     ...
                     /* Pin Multiplex Control: PORT1_1 (pin 57) is configured as LPSPI0_SCK. */
                     | PORT_PCR_MUX(PORT1_PCR1_MUX_mux10)
    ...
    PORT1->PCR[3] = ((PORT1->PCR[3] &
                     ...
                     /* Pin Multiplex Control: PORT1_3 (pin 59) is configured as LPSPI0_PCS0. */
                     | PORT_PCR_MUX(PORT1_PCR3_MUX_mux10)

                     /* Input Buffer Enable: Enables. */
                     | PORT_PCR_IBE(PCR_IBE_ibe1));

    /* PORT1_4 (pin 62) is configured as P1_4 */
    PORT_SetPinMux(BOARD_INITPINS_BOARD_ILI9341_DC_PIN_PORT, BOARD_INITPINS_BOARD_ILI9341_DC_PIN_PIN, kPORT_MuxAlt0);
    ...
    PORT_SetPinMux(BOARD_INITPINS_BOARD_ILI9341_RST_PIN_PORT, BOARD_INITPINS_BOARD_ILI9341_RST_PIN_PIN, kPORT_MuxAlt0);
    ...
    PORT_SetPinMux(BOARD_INITPINS_BOARD_ILI9341_BL_PIN_PORT, BOARD_INITPINS_BOARD_ILI9341_BL_PIN_PIN, kPORT_MuxAlt0);
    ...
    gpio_pin_config_t BOARD_ILI9341_DC_PIN_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO1_4 (pin 62)  */
    GPIO_PinInit(BOARD_INITPINS_BOARD_ILI9341_DC_PIN_GPIO, BOARD_INITPINS_BOARD_ILI9341_DC_PIN_PIN, &BOARD_ILI9341_DC_PIN_config);

    gpio_pin_config_t BOARD_ILI9341_RST_PIN_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO1_5 (pin 63)  */
    GPIO_PinInit(BOARD_INITPINS_BOARD_ILI9341_RST_PIN_GPIO, BOARD_INITPINS_BOARD_ILI9341_RST_PIN_PIN, &BOARD_ILI9341_RST_PIN_config);

    gpio_pin_config_t BOARD_ILI9341_BL_PIN_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO1_6 (pin 64)  */
    GPIO_PinInit(BOARD_INITPINS_BOARD_ILI9341_BL_PIN_GPIO, BOARD_INITPINS_BOARD_ILI9341_BL_PIN_PIN, &BOARD_ILI9341_BL_PIN_config);
